...
We can do a simple Depth-First Traversal on the Tree. We maintain sum which will store sum of deepest leaves and deepest which will be the depth of the deepest nodes. There will be following cases available to us where current Node is -
...
Lastly, we will return the sum accumulated till now. The implementation of this is given below
